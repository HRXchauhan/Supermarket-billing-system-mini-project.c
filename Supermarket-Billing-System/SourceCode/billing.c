/* ============================================================
   ...
   Concepts used: Structures, Arrays, Functions, Loops,
                  Conditional Statements, In-memory Storage
   ============================================================ */
...
/* ------------------------------------------------------------
   loadProducts
   Starts with an empty in-memory inventory.
   ------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   saveProducts
   No-op placeholder since the program now uses in-memory data.
   ------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   ...
   Returns a unique invoice number for the current session.
   ------------------------------------------------------------ */
...
/* ------------------------------------------------------------
   generateInvoice
   Prints an itemized invoice to the console.
   ------------------------------------------------------------ */
